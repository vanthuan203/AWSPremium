...
public class AccountViewController {
    ...
    @GetMapping(value = "/getAccountNewOFF", produces = "application/hal+json;charset=utf8")
    ResponseEntity<String> getAccountNewOFF(@RequestParam(defaultValue = "") String vps, @RequestParam(defaultValue = "vn") String geo,@RequestParam(defaultValue = "0") Integer cmt,@RequestHeader(defaultValue = "") String Authorization) throws InterruptedException {
        JSONObject resp = new JSONObject();
        Random ran = new Random();
        Integer checktoken = adminRepository.FindAdminByToken(Authorization);
        if (checktoken == 0) {
    ...
    @GetMapping(value = "/getAccountNew", produces = "application/hal+json;charset=utf8")
    ResponseEntity<String> getAccountNew(@RequestParam(defaultValue = "") String vps, @RequestParam(defaultValue = "vn") String geo,@RequestParam(defaultValue = "0") Integer cmt,@RequestHeader(defaultValue = "") String Authorization) throws InterruptedException {
        JSONObject resp = new JSONObject();
        Random ran = new Random();
        Integer checktoken = adminRepository.FindAdminByToken(Authorization);
        if (checktoken == 0) {
