...
public interface YoutubeLike24hRepository extends JpaRepository<YoutubeLike24h,String> {
    @Modifying
    @Transactional
    @Query(value = "delete from youtube_like_24h where round((UNIX_TIMESTAMP()-update_time/1000)/60/60)>24;",nativeQuery = true)
