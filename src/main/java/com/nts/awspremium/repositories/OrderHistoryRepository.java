...
public interface OrderHistoryRepository extends JpaRepository<OrderHistory,Long> {
    @Query(value = "SELECT o from OrderHistory o JOIN FETCH o.service where o.order_id=?1")
    ...
    @Query(value = "SELECT GROUP_CONCAT(order_key) from (SELECT order_key FROM Data.order_history where service_id in(select service_id from service_smm where platform=?1 and task=?2) \n" +
    ...
    @Modifying
    @Transactional
    @Query(value = "update order_history set current_count=?1,update_current_time=?2,mode_check=?3 where order_key=?4 and service_id in(select service_id from service_smm where platform=?5 and task=?6) and round((UNIX_TIMESTAMP()-end_time/1000)/60/60)>=8 and round((UNIX_TIMESTAMP()-end_time/1000)/60/60)<24",nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "update order_history set valid=0,update_time=?1 where order_key in (?2) and service_id in(select service_id from service_smm where platform=?3 and task=?4)",nativeQuery = true)
    ...
    @Query(value = "Select o.order_id,o.order_key,o.order_link,o.insert_time,o.start_time,o.end_time,o.cancel,o.note,\n" +
            ...
            "s.task,s.mode from order_history o left join service_smm s on o.service_id=s.service_id where o.order_key in (?1) or o.order_id in (?1)\n" +
    ...
    @Query(value = "Select o.order_id,o.order_key,o.order_link,o.insert_time,o.start_time,o.end_time,o.cancel,o.note,\n" +
            "o.start_count,o.quantity,o.username,o.total,o.current_count,\n" +
            "o.update_time,o.update_current_time,o.refund,o.refund_time,o.refill,o.refill_time,o.charge,o.service_id,s.platform,s.check_count,s.bonus,\n" +
            "s.task,s.mode from order_history o left join service_smm s on o.service_id=s.service_id where  (o.order_key in (?1) or o.order_id in (?1)) and o.username=?2 \n" +
            "order by o.end_time desc",nativeQuery = true)
    ...
    @Query(value = "Select o.order_id,o.order_key,o.order_link,o.insert_time,o.start_time,o.end_time,o.cancel,o.note,\n" +
            "o.start_count,o.quantity,o.username,o.total,o.current_count,\n" +
            "o.update_time,o.update_current_time,o.refund,o.refund_time,o.refill,o.refill_time,o.charge,o.service_id,s.platform,s.check_count,s.bonus,\n" +
            "s.task,s.mode from order_history o left join service_smm s on o.service_id=s.service_id\n" +
            "order by o.end_time desc",nativeQuery = true)
    ...
    @Query(value = "Select o.order_id,o.order_key,o.order_link,o.insert_time,o.start_time,o.end_time,o.cancel,o.note,\n" +
            "o.start_count,o.quantity,o.username,o.total,o.current_count,\n" +
            "o.update_time,o.update_current_time,o.refund,o.refund_time,o.refill,o.refill_time,o.charge,o.service_id,s.platform,s.check_count,s.bonus,\n" +
            "s.task,s.mode from order_history o left join service_smm s on o.service_id=s.service_id where  o.username=?1 \n" +
            "order by o.end_time desc",nativeQuery = true)
