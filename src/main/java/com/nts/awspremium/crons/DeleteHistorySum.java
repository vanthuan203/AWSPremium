...
import com.nts.awspremium.controller.HistoryCommentController;
import com.nts.awspremium.controller.HistoryViewController;
                ...
                new Thread(() -> {
                    ...
                    while (true) {
                        try {
                            ...
                            historyViewController.delhistorysumcron();
                            try {
                                Thread.sleep(5000);
                            } catch (InterruptedException e) {
                                throw new RuntimeException(e);
                            }
                            historyCommentController.delhistorysumcron();
                        } catch (Exception e) {
                            continue;
                        }
                    }
